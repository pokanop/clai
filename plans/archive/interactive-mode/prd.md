...
- **Success Criteria**
  ...
  - **SC-4:** The implementation respects the **NO_COLOR** convention when the environment variable is set (no ANSI color in that case). *([https://no-color.org/](https://no-color.org/))*
